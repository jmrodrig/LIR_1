...
public class MultipartRequest extends Request<String> {
    ...
    private final FileBody mFileBody;

    public MultipartRequest(String url, String fileName, FileBody fileBody , Response.Listener<String> listener, Response.ErrorListener errorListener) {
